...
from Users.blockchain import get_customer_from_blockchain
...
MODEL_PATH = os.path.join(settings.BASE_DIR, 'loan_approval_model.pkl')
SCALER_PATH = os.path.join(settings.BASE_DIR, 'standard_scaler.pkl')
ENCODER_COLUMNS = ['person_gender', 'person_education', 'person_home_ownership', 'loan_intent', 'previous_loan_defaults_on_file']
ENCODER_PATHS = {col: os.path.join(settings.BASE_DIR, f'{col}_label_encoder.pkl') for col in ENCODER_COLUMNS}
